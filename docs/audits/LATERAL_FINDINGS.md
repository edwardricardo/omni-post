...
**Severidad estimada:** bajo
**Acción propuesta:** actualizar la tabla §6 de PLAN_MAESTRO.md tras el cierre de D0.
...
**Severidad estimada:** medio
**Acción propuesta:** actualizar `seed.ts` para incluir los 2 permisos en los arrays de SUPER_ADMIN + ADMIN + SUPPORT (según lo que haya decidido el fix de 2026-04-10). D3 o D5 lo puede formalizar.
