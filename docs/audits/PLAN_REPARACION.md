...
| **S2** | 3-preguntas one-by-one (threading + 3 archivos) | F11, F12, F13, F14                 | PENDIENTE — req. D4, D5 | _(pendiente)_                    | _(pendiente)_ |
| **S3** | Mecánicos combinados                            | F1, F2, F3, F16, F17, F22, F30–F34 | PENDIENTE — D1 ✓        | _(pendiente)_                    | _(pendiente)_ |
...
| **D4** | `@core/threading` — aplicar 3 preguntas     | S2             | PENDIENTE             | Requiere aplicación 1-a-1 de las 3 preguntas en S2.1.                                                                                                                           |
| **D5** | F12–F14 archivos knip — aplicar 3 preguntas | S2             | PENDIENTE             | Requiere aplicación 1-a-1 de las 3 preguntas en S2.2-S2.4.                                                                                                                      |
...
| ------------------------------------- | ------------------------------- | --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| F1 typescript 6.0.2                   | ALTO                            | S3.1                        | PENDIENTE                                                                                                                                                                              |
| F2 tsx version drift                  | MEDIO                           | S3.2                        | PENDIENTE                                                                                                                                                                              |
| F3 jq devDep broken                   | MEDIO                           | S3.3                        | PENDIENTE                                                                                                                                                                              |
...
| F11 core/threading huérfano           | MEDIO                           | S2.1                        | PENDIENTE — aplicar 3 preguntas                                                                                                                                                        |
| F12 bruteForceProtection unused       | BAJO                            | S2.2                        | PENDIENTE — aplicar 3 preguntas                                                                                                                                                        |
| F13 useSagaStatus unused              | BAJO                            | S2.3                        | PENDIENTE — aplicar 3 preguntas                                                                                                                                                        |
| F14 useStartPostPublishingSaga unused | BAJO                            | S2.4                        | PENDIENTE — aplicar 3 preguntas                                                                                                                                                        |
| F15 _(audit)_                         | _(reservar para audit re-read)_ | —                           | —                                                                                                                                                                                      |
| F16 i18n/request.ts dup               | MEDIO                           | S3.4                        | PENDIENTE                                                                                                                                                                              |
| F17 notificationStore.ts dup          | MEDIO                           | S3.5                        | PENDIENTE                                                                                                                                                                              |
...
| F22 fastify.X outliers (5)            | BAJO                            | S3.6                        | PENDIENTE (opcional)                                                                                                                                                                   |
...
| F30 knip dep unused #1                | BAJO                            | S3.7                        | PENDIENTE                                                                                                                                                                              |
| F31 knip dep unused #2                | BAJO                            | S3.7                        | PENDIENTE                                                                                                                                                                              |
| F32 knip dep unused #3                | BAJO                            | S3.7                        | PENDIENTE                                                                                                                                                                              |
| F33 knip dep unused #4                | BAJO                            | S3.7                        | PENDIENTE                                                                                                                                                                              |
| F34 knip dep unused #5                | BAJO                            | S3.7                        | PENDIENTE                                                                                                                                                                              |
