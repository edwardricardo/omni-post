...
| **A6.6**  | `TokenService` (jwt-algorithm canon) + `CredentialPort` + logger | customer-auth COMPLETO (6) + team/InviteTeamMember (7). Su email ya fue a port en A6.4; restan passwordHashing(A6.5)/customerJwt/PlatformCredentialService/lib-logger. Mayor riesgo.                                                                                                                                                                                                                                                              | Alta        | PENDING        |
