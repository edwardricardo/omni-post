...
de use-cases a inyección → mover a `@core/application` (cp + rewrite + shim) → gates → commit. Cobertura: 4+7+9+2+2+7+1
= **32** (todos los bloqueados; A6.1 ajustado 5→4 y A6.4 1→2 al pasar SendEmailNotificationService a A6.4).
