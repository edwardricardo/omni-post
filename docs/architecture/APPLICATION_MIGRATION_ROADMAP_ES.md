...
| **A6.3b** | ai-image (ImageGenerationPort)                                   | ai-image/GenerateImage: port nuevo `generateImage` + relocar tipos de imagen a @core (1).                                                                                                                                                                                                                                                                                                                                                         | Media       | PENDING        |
...
| A6.3b    | ai-image — `ImageGenerationPort` nuevo + tipos imagen                                  | 1            | independiente                           |
