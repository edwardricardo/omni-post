...
| **COMPENSATING huérfanas** | 0                                                     | `max(saga_compensating_orphans)`                                                                                                    | [SagaCompensatingOrphans](../security/MULTI_TENANT_GUARDS.md) (`prometheus/alerts/saga.yml`)                                                           | [MULTI_TENANT_GUARDS.md](../security/MULTI_TENANT_GUARDS.md) |
