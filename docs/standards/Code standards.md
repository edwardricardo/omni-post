...
**Historical context:** 461 of 471 endpoints follow this convention. The 8 SAML/OIDC endpoints that used `/api/` prefix were fixed 2026-04-18 (PLAN_MAESTRO §6). The 2 CQRS endpoints that still use it are DEAD_CODE pending removal.
