/**
 * @file health.test.ts
 * @description Pins the client container's liveness contract. This route was
 *              ABSENT while both portal Dockerfiles' HEALTHCHECK requested it,
 *              so every client container reported `unhealthy` for its whole life.
...
describe("GET /api/health (client liveness)", () => {
