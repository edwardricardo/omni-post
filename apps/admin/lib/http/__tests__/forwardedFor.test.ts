 ...
 * @description Unit tests for the admin client-IP relay helper. Verifies verbatim
 *              relay of the inbound X-Forwarded-For chain (no appended portal
 *              hop), the X-Real-IP fallback, XFF precedence, and the empty result
...
describe("forwardedForHeaders (admin)", () => {
