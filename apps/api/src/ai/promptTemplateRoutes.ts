...
export const promptTemplateRoutes: FastifyPluginAsync = async (app) => {
  ...
  app.get("/api/ai-templates", (request: FastifyRequest, reply: FastifyReply) =>
    handler.list(request, reply)
  );

  app.post("/api/ai-templates", (request: FastifyRequest, reply: FastifyReply) =>
    handler.create(request, reply)
  );

  app.patch("/api/ai-templates/:id", (request: FastifyRequest, reply: FastifyReply) =>
    handler.update(request, reply)
  );

  app.delete("/api/ai-templates/:id", (request: FastifyRequest, reply: FastifyReply) =>
