...
import type { ListAIPromptTemplatesQuery } from "@core/aiPromptTemplates/ListAIPromptTemplatesQuery.js";
import type { CreateAIPromptTemplateUseCase } from "@core/aiPromptTemplates/CreateAIPromptTemplateUseCase.js";
import type { UpdateAIPromptTemplateUseCase } from "@core/aiPromptTemplates/UpdateAIPromptTemplateUseCase.js";
import type { DeleteAIPromptTemplateUseCase } from "@core/aiPromptTemplates/DeleteAIPromptTemplateUseCase.js";
...
class PromptTemplateRouteHandler extends BaseRouteHandler {
  ...
  async create(request: FastifyRequest, reply: FastifyReply): Promise<void> {
    ...
    const result = await this.createUseCase.execute({
      ...
      prompt: body.prompt,
      variables: body.variables as import("@core/aiPromptTemplates/types.js").TemplateVariableDto[],
      tone: body.tone,
    });
    if (!result.ok) {
  ...
  async update(request: FastifyRequest, reply: FastifyReply): Promise<void> {
    ...
    const body = bodyValidation.value;
    const input: import("@core/aiPromptTemplates/types.js").UpdateAIPromptTemplateInput = {
    ...
    if (body.variables !== undefined) {
      input.variables =
        body.variables as import("@core/aiPromptTemplates/types.js").TemplateVariableDto[];
    }
