...
async function main() {
  ...
  // try/finally guarantees the connection is quit on EVERY exit path, including
  // a mid-flight throw (e.g. repo.createPost rejecting) — otherwise the socket
  // would leak and the script would hang instead of exiting cleanly.
  try {
