 ...
 * @description Vitest configuration for the Threads provider — mirrors the
 *              telegram provider config (workspace alias resolution + node
 *              environment + forked workers).
