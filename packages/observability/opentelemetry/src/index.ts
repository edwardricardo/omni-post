/**
 * @file index.ts
 * @description OpenTelemetry NodeSDK bootstrap for the platform — configures trace and metric
 *              exporters, resource attributes, and auto-instrumentation for HTTP, Fastify, Redis.
