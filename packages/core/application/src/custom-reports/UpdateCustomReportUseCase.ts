  ...
  async execute(input: UpdateCustomReportInput): Promise<Result<void, UseCaseError>> {
    const doWork = async (): Promise<Result<void, UseCaseError>> => {
      ...
      const entity = CustomReport.reconstitute({
        ...
        name: dto.name,
        metrics: dto.metrics as import("@core/domain/analytics/ReportSchema.js").MetricKey[],
        dimensions:
          dto.dimensions as import("@core/domain/analytics/ReportSchema.js").DimensionKey[],
        dateRange:
          dto.dateRange as import("@core/domain/analytics/ReportSchema.js").DateRangePreset,
        chartType: dto.chartType as import("@core/domain/analytics/ReportSchema.js").ChartType,
